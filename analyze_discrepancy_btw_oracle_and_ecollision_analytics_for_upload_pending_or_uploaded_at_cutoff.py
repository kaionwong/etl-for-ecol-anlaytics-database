...
analytics_filename = 'main_extract_ecollision_analytics_data_2000-2024_snapshot_from_2024-07-22.csv'
...
if save_switch:
    ...
    output_filename = f'unique_case_number_from_oracle_not_in_ecol_analytics_{start_date_str}_{end_date_str}_done_at_{timestamp_str}.csv'
