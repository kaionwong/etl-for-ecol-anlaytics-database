...
extract_sql_snapshot1 = f'data\main_extract_ecollision_oracle_data_2000_onward_snapshot_from_{filename_date1}.csv' 
extract_sql_snapshot2 = f'data\main_extract_ecollision_oracle_data_2000_onward_snapshot_from_{filename_date2}.csv'
