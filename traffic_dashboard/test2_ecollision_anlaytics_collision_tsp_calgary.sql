...
SELECT c.ID [Collision_ID]
	  ...
	  ,CASE WHEN CONVERT(char(5),OCCURENCE_TIMESTAMP,108)='00:00' THEN 'Unspecified'			--Use OCCURENCE_TIMESTAMP to get Time instead of using Occurrence Time. There are many NULLs under OCCURENCE_TIME for 2019 data.
			...
			END
	   END Time_Group	
	  --,CASE WHEN OCCURENCE_TIME =0 OR OCCURENCE_TIME is NULL THEN 'Unknown'
			--ELSE CASE
			--WHEN OCCURENCE_TIME >=2300 OR OCCURENCE_TIME<300 THEN '5 11:00 pm - 2:59 am (Late Evening)'
			--WHEN OCCURENCE_TIME BETWEEN 300 AND 659 THEN '6 3:00 am - 6:59 am (Early Morning)'
			--WHEN OCCURENCE_TIME BETWEEN 700 AND 1059 THEN '1 7:00 am - 10:59 am (Morning Rush Hour)'
			--WHEN OCCURENCE_TIME BETWEEN 1100 AND 1459 THEN '2 11:00 am - 2:59 pm (Midday)'
			--WHEN OCCURENCE_TIME BETWEEN 1500 AND 1859 THEN '3 3:00 pm - 6:59 pm (Evening Rush Hour)'
			--WHEN OCCURENCE_TIME BETWEEN 1900 AND 2259 THEN '4 7:00 pm - 10:59 pm (Evening)'
			--ELSE 'Unspecified'
			--END
	  -- END Time_Group
