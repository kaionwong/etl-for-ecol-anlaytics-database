...
WITH CollisionCutoffDates AS (
    ...
    SELECT 2030 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2029 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2028 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2027 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2026 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2025 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2024 AS created_year, TO_DATE('3999-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2023 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2022 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2021 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2020 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2019 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2018 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2017 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2016 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2015 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2014 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2013 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2012 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2011 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2010 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2009 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2008 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2007 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2006 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2005 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL UNION ALL
    SELECT 2004 AS created_year, TO_DATE('2030-12-31', 'YYYY-MM-DD') AS cutoff_end_date FROM DUAL
),
