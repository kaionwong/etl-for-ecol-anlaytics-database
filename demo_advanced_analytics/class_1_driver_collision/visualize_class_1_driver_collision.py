...
2. Navigate to the directory:
   cd demo_advanced_analytics

3. Run the Streamlit app:
   streamlit run visualize_class_1_driver_collision.py

   OR using full path:
   C:\Users\kai.wong\Dev\virtual_env\venv_etl_for_ecol_analytics\Scripts\streamlit.exe run visualize_class_1_driver_collision.py
...
- class_1_driver_risk_analysis.py (in same directory)
...
import class_1_driver_risk_analysis as ra
