...
WHERE 1=1
-- AND (c.POLICE_SERVICE_CODE in ('304', '0304', '1193', '6796', 'EPS') OR c.LOC_DESC like '%edmonton%')
-- AND (c.POLICE_SERVICE_CODE in ('EPS'))
-- AND (c.POLICE_SERVICE_CODE in ('304', '0304', 'EPS') OR c.LOC_DESC like '%edmonton%')
-- AND c.POLICE_SERVICE_CODE in ('304', '0304', '1193', '6796', 'EPS')
-- AND c.POLICE_SERVICE_CODE in ('304', '0304', 'EPS')
...
AND c.CASE_YEAR between 2000 and 2026
