...
--        ,plot.HIGHWAY -- [] need checking/debugging
        ...
        ,CASE WHEN obj.OBJECT_TYPE_ID=1 THEN 'Driver'
            ...
            END OBJECT_TYPE	      
          ,obj.SEQ_NBR
--          ,CASE WHEN obj.OBJECT_TYPE_ID ='10' THEN cond.Object_NBR			-- Object Number for Passenger -- [] this needs testing/debugging
--                ELSE SEQ_NBR
--            END Object_NBR
--          ,Case WHEN obj.OBJECT_TYPE_ID=5 THEN pro1.OBJECT_IDENTIFICATION_TYPE_ID		--Parked Vehicle
--                WHEN obj.OBJECT_TYPE_ID=10 THEN v.OBJECT_IDENTIFICATION_TYPE_ID			--Passenger  -- [] this v needs testing/debugging
...
--                WHEN v.Flag_ParkedVehicle='Y' THEN 'Y' -- [] this v needs testing/debugging
--                ELSE 'N'
--            END Flag_ParkedVehicle
          ,obj.DESCRIPTION Obj_Description
--          ,CASE WHEN Anim.Flag_Animal is NULL THEN 'N' ELSE Anim.Flag_Animal END Flag_Animal -- [] this needs testing/debugging
--          ,CASE WHEN Anim.Flag_Animal='Y' THEN Anim.DESCRIPTION END Anim_Description -- [] this needs testing/debugging
--          ,CASE WHEN Oth_Prop.Flag_Oth_Property is NULL THEN 'N' ELSE Oth_Prop.Flag_Oth_Property END Flag_Oth_Property -- [] this needs testing/debugging
          ,obj.ID Obj_ID
...
--          ,CASE WHEN obj.OBJECT_TYPE_ID=10 THEN cond.DRIVER_PEDESTR_COND_ID		--Add Driver/Pedestrian Condition to Passenger  -- [] testing/debugging
--           ELSE par.DRIVER_PEDESTR_COND_ID
--           END DRIVER_PEDESTR_COND_ID
          ,par.POSITION_IN_VEHICLE_ID
--          ,p.SHORT_DESC Position_in_Vehicle  -- [] testing/debugging
--          ,p.CODE	Position_in_Vehicle_Code  -- [] testing/debugging
          ,par.UNSAFE_SPEED_ID
          ,par.DRIVER_DISTRACTION_ID
          ,par.EJECTION_TYPE_ID
          ,par.SAFETY_EQUIPMENT_ID
--          ,s.SHORT_DESC SAFETY_EQUIPMENT  -- [] testing/debugging
--          ,s.CODE SAFETY_EQUIPMENT_Code  -- [] testing/debugging
...
--          ,loc.SHORT_DESC Collision_Location -- [] testing/debugging 
...
--          ,plot.KM_POST
          ...
          ,c.SURFACE_COND_ID
--          ,c.OCCURENCE_TIMESTRING -- [] checking/debuging
          ,c.OCCURENCE_TIMESTAMP
--          --,d.FiscalYear
--          --,d.SchoolYearFlag
          ,CASE 
